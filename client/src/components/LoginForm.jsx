...
const LoginForm = () => {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      const response = await fetch(
        "https://gharbanao-5aje.onrender.com/api/auth/forgot-password",
        {
          method: "POST",
  ...
  //   try {
  //     const response = await fetch(
  //       "https://gharbanao-5aje.onrender.com/api/auth/verify-reset-otp",
  //       {
  //         method: "POST",
  //         headers: { "Content-Type": "application/json" },
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      const response = await fetch(
        "https://gharbanao-5aje.onrender.com/api/auth/reset-password",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
